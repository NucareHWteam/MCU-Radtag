...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    */
    ...
    /* USER CODE BEGIN ADC1:ADC_COMP1_2_IRQn disable */
    /**
    * Uncomment the line below to disable the "ADC_COMP1_2_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(ADC_COMP1_2_IRQn); */
    /* USER CODE END ADC1:ADC_COMP1_2_IRQn disable */
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  if(hcomp->Instance==COMP1)
  {
    ...
    */
    ...
    /* USER CODE BEGIN COMP1:ADC_COMP1_2_IRQn disable */
    /**
    * Uncomment the line below to disable the "ADC_COMP1_2_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(ADC_COMP1_2_IRQn); */
    /* USER CODE END COMP1:ADC_COMP1_2_IRQn disable */
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* hpcd)
{
  if(hpcd->Instance==USB_DRD_FS)
  {
    ...
    //FIXME: Due to DP and DM not autonomously generated so do it manually
        /**USB_OTG_FS GPIO Configuration
        PA11     ------> USB_OTG_FS_DM
        PA12     ------> USB_OTG_FS_DP
        */
