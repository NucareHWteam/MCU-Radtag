...
#define UX_DEVICE_CLASS_HID_EVENT_BUFFER_LENGTH             128/2

/* Defined, this value represents the the maximum number of HID events/reports
   that can be queued at once.
 */

#define UX_DEVICE_CLASS_HID_MAX_EVENTS_QUEUE                16/2
...
#define UX_MAX_DEVICE_ENDPOINTS              3
